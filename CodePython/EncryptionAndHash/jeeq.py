...
# 		# print_help(True)
		...
		# import base58
		#
		# pubkey= '02cef97eaef487bcf2479029612dd77b7985e92277078a63f6bf1a852007af2c55'
		#         pubkey=pubkey.decode('hex')
		#         encrypted_message=encrypt_message(pubkey,"Guillaume")
		#         print(encrypted_message)
		#         encrypted_message=encrypted_message.encode('hex')
		#         private_key= 'PkPEAoUzAxMYKQEDZdH3qS3r8mBQAxSEqW8Y3sqRegLjoHhqBnhf'
		#         private_key=base58.b58decode(private_key)
		#         print(private_key)
		#         private_key=private_key.decode('hex')
		#         message=decrypt_message(private_key, encrypted_message, verbose=True, generator=generatorBitcoin)
		#         print(message)
